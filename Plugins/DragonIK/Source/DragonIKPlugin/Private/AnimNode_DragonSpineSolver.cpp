...
*/
				...
				FVector Right_Altered_Vector = ((RightVectorCalculated*100 + character_direction_vector_CS*-Intensifier_side) - FVector::ZeroVector).GetUnsafeNormal();
...
*/
				...
				FVector Right_Altered_Vector = ((RightVectorCalculated*100 + character_direction_vector_CS*-right_intensity) - FVector::ZeroVector).GetUnsafeNormal();
				FQuat RightDiffNormal = FQuat::FindBetweenNormals(( RightVectorCalculated ),(Right_Altered_Vector));
