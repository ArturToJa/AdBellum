...
public:
	...
	float GetSoundVolumeMultiplier(EALSGait Gait, EALSStance Stance)
	{
		// Using a constexpr lookup table for maximum efficiency
		constexpr float VolumeTable[3][3] = {
			{0.5f, 0.20f, 0.2f},    // Walking: Standing, Crouching, Proning
			{1.0f, 0.66f, 0.5f},     // Running: Standing, Crouching, Proning
			{1.25f, 0.9f, 0.7f}      // Sprinting: Standing, Crouching, Proning
		};

		return VolumeTable[static_cast<uint8>(Gait)][static_cast<uint8>(Stance)];
	}
};
